...
### DT-017 — Description inventée du système de parade dans le README

| Champ | Détail |
|---|---|
| **Fichier** | `README.md` |
| **Méthode** | Section "Système de jetons parade" |
| **Sévérité** | 🟠 Significatif |
| **Type** | Documentation |

**Description :**
Le README décrivait la parade avec deux affirmations fausses : (1) "N = nombre de personnages dans le camp adverse", (2) "la cible peut dépenser 1 jeton pour annuler les dégâts". Le paragraphe "Impact stratégique" (infériorité numérique, coordination des attaques) décrivait une mécanique entièrement fictive.

**Problème :**
La réalité du code (`models/character.py`) : pour les héros, `max_parade_tokens = get_equipment_bonus('defense')` ; pour les ennemis, `max_parade_tokens = stats.get('defense', 0)`. Chaque jeton absorbe automatiquement **1 point de dégât** (`blocked_damage = min(damage, current_parade_tokens)`). L'IA a généré une description plausible mais déconnectée du code réel — probablement inspirée de mécaniques de parade classiques d'autres jeux.

✅ **Corrigé** — README mis à jour avec la description exacte issue du code (session H21 — 2026-06-15).
...
| DT-017 | `README.md` | 🟠 Significatif | ✅ Corrigé — README mis à jour (H21 — 2026-06-15) |

---

*Dernière mise à jour : session review 6 H21 — 2026-06-15*
